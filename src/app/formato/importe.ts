/**
 * Formato de un importe para pantalla, en castellano: `USD 13.720,00` (F0-20).
 *
...
/** El monto sin moneda: `13.720,00`, `-0,05`. */
...
/** El monto con su código de moneda adelante: `USD 13.720,00`. */
