...
/**
 * F0-20 · Formato de un importe para pantalla, en castellano (`USD 13.720,00`).
...
describe("formatearImporte: USD 13.720,00", () => {
  it.each([
    [1_372_000n, "USD", "USD 13.720,00"],
    [1_372_050n, "ARS", "ARS 13.720,50"],
